...
Ari needs your workspace's **Last close** date set before it can build the active-employee payroll formula. See [Actuals, Forecast, and formula ranges](/formulas/core-concepts/actuals-forecast-and-formula-ranges). If Last close is not set, Ari can explain the required workspace setting.

...
- Right-click a cell and choose **Mention cell in chat** for the same result. A Canvas block offers **Mention block in chat**, and a Page in the sidebar offers **Mention page in chat**.

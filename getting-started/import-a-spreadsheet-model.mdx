...
Ask Ari to compare the rebuilt values with the source workbook, explain any differences, and list the assumptions it had to infer.

> Reconcile the rebuilt revenue, payroll, and cash totals to the source workbook for every quarter. Explain any difference you cannot resolve.

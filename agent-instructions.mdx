...
The MCP connection provides cfo.ai's modeling instructions during initialization. Use `inspect_reference` to read the relevant product guidance, and inspect the existing workspace before creating or changing content.

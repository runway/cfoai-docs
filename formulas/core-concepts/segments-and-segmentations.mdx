...
When a formula is calculated by month, quarter, or year, Date is part of its segmentation. This matters when a formula uses a FormulaRange such as Actuals or Forecast.

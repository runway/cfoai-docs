...
<Frame>
  <iframe src="https://grossprofitwalkthrough.runwaydev.com/" className="w-full rounded-xl" style={{ height: "900px", border: "none" }} title="Interactive walkthrough: build the Gross Profit formula" />
</Frame>
...
For a first formula, use the broadest scope so it acts as the default calculation for the Variable.

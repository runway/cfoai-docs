...
A visual reads your Model but cannot write to it. A slider or other control on a visual changes a local preview only; to change a saved assumption, edit the Variable or the value in a Table Block.

...
- A FormulaRange on a formula without Date scope
...
Check the FormulaRange, Date scope, Date granularity, scenario, and Last close. A formula assigned to Actuals or Forecast must include Date in its scope.

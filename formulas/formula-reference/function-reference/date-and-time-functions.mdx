...
description: "Shift dates, calculate differences, count days in a period, construct dates, and find month-end dates."
---
...
- [Date-part functions](/formulas/formula-reference/function-reference/date-part-functions)

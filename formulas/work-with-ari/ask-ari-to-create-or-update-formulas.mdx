...
## Choose the FormulaRange

> Use imported Payroll for Actuals and Headcount times Average Salary for Forecast.

FormulaRange formulas must be scoped by Date. If Date is not part of the formula context, Ari must add Date scope or explain why the FormulaRange cannot be applied.

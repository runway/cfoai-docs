...
- **Images and PDFs** are made available directly for Ari to inspect. Image support depends on the model your workspace uses for Ari; if an image cannot be read, Ari says so before sending the request.
...
- A file you uploaded has a **Download** button on its tile in the chat transcript, so you can retrieve it later under its original filename.

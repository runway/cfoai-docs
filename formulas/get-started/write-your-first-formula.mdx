...
<Frame>
  <iframe src="https://grossprofitwalkthrough.runwaydev.com/" className="w-full rounded-xl" style={{ aspectRatio: "1493/823", border: "none" }} title="Interactive walkthrough: build the Gross Profit formula" />
</Frame>

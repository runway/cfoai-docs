...
The formula columns start hidden. Rest the pointer on the **fx** button (**Show formulas**) at the top of the row-name column to peek at them: the formula columns slide out over the table, stay while the pointer is on them, and slide away when it leaves. Click the button to keep them; the month columns move over to make room, and the choice is saved for this browser. Click it again (**Hide formulas**) to hide them.
